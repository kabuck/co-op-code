...
plt.xlabel("at% Cu", **tnrfont)
plt.ylabel("at% Fe", **tnrfont)
plt.show()

clf = neighbors.KNeighborsClassifier(n_neighbors = 9, weights='distance')
clf.fit(X, y)
