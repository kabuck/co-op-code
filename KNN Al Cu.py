...
f1score = f1_score(test_predict, Y_test, average = "weighted")
...
plt.xlabel("at% Al", **tnrfont)
plt.ylabel("at% Cu", **tnrfont)
plt.show()

clf = neighbors.KNeighborsClassifier(n_neighbors = 7, weights='distance')
clf.fit(X, y)
