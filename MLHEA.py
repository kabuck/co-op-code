...
print(df.shape)
headers = ["Alloy No.", "Al%", "Co%", "Cr%", "Cu%", "Fe%", "Ni%", "Predicted HV-Mean", "Prediced HV-sd"]
...
X = df[["Al%", "Co%", "Cr%", "Cu%", "Fe%", "Ni%"]].values.astype(int)
X[0:5]
y = df[["Predicted HV-Mean"]].values.astype(float)
y[0:5]
...
print("Train set accuracy: ", metrics.accuracy_score(y_trian, neigh.predict(X_train)))
