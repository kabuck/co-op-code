...
#KNN Implementation
clf = KNeighborsClassifier(n_neighbors = 11, weights = "uniform", algorithm = "auto")
...
#Create color maps
cmap_light = ListedColormap(['lightblue', 'orange','pink'])
cmap_bold = ListedColormap(['blue', 'darkblue','purple'])
